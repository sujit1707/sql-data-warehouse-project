-- ======================================================
-- Silver Load Script
-- Transforms bronze layer data into cleaned, standardized silver tables.
-- This script is fully re-runnable.
--
-- Execution Order:
-- 1. bronze_ddl.sql
-- 2. bronze_load.sql
-- 3. silver_ddl.sql
-- 4. silver_load.sql   <-- (this script)
--
-- HOW TO RUN:
...
--   -U postgres `
--   -d datawarehouse `
--   -f scripts/silver/silver_load.sql
--
-- Notes:
-- - Assumes bronze layer has already been loaded.
-- - Script truncates silver tables before inserting.
